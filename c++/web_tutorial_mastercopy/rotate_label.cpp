...
int main(int argc, char **argv) {
	...
	Text l;
	l.setAnchorLocation(0, 0);
	l.setFontSize(8.);
	l.setStrokeWidth(0.0f);
	l.setText("abcdljjjlllmmmm");
...
//	l.setRotationAngle(15.);
	...
	Text l2;
	l2.setAnchorLocation(50, 50);
	l2.setFontSize(12.);
	l2.setStrokeWidth(0.0f);
	l2.setText("ABCDLJJJIIILLLMMMM");
	l2.setStrokeWidth(0.0f);
...
//	l2.setRotationAngle(-50.0f);
	...
	Text l3;
	l3.setAnchorLocation(-50, -20);
	l3.setFontSize(12.);
	l3.setStrokeWidth(0.0f);
	l3.setText("ZYX cba TUV def CBA");
	l3.setStrokeWidth(0.0f);
