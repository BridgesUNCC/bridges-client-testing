...
def main():
    ...
    genres = ["Mystery", "Comedy", "Documentary", "Drama", "Romance", "Crime", "Thriller", "Biography", "Horror",
              "News", "Action", "Adventure", "Animation", "Family", "Sci-Fi", "Music", "Sport", "Short", "Musical",
              "History", "Talk-Show", "Reality-TV", "Game-Show", "Fantasy", "War"]
