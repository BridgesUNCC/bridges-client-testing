...
public class face_shp_coll {
	...
	public static void main(String[] args) throws Exception {
...
#endif
		// title, description
		bridges.setTitle("Face Example using Symbols");
		bridges.setDescription("An example of a simple figure using symobols, and transformations on symbols.");
		...
		Polyline s6 = new Polyline();
			s6.addPoint(-50.0f, 0.0f); 
			s6.addPoint(0.0f, 50.0f); 
			s6.addPoint(50.0f, 0.0f); 
		sc.addSymbol(s6);

		Label l = new Label();
			l.setLocation(0.0f,100.0f);
			l.setFontSize(16);
