...
public class graph_imdb_by_genre{
	...
	public static void main(String[] args) throws Exception {
		...
		GraphAdjListSimple<String> g = new GraphAdjListSimple<>();
	...
	public static void create_genre_vertices(GraphAdjListSimple<String> g,  
								String[] genres) {
	...
	public static void group_movies_by_actors(GraphAdjListSimple<String> g,
			List<ActorMovieIMDB> actor_movie_data) {
						...
						// ActorMovieIMDB::getMovie(), getRating(), 
		...
		HashMap<String, Element<String>> verts = g.getVertices();
